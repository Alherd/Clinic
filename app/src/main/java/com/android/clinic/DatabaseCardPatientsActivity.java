...
public class DatabaseCardPatientsActivity extends AppCompatActivity {
    ...
    public void onResume() {
        ...
        userCursor = db.rawQuery("select * from " + DatabaseHelper.TABLE_MEDICAL_CARD_PATIENTS +
                " where " + DatabaseHelper.COLUMN_ID_PATIENT_MAP + " = '" + KeyValues.sIdPatient + "' ;", null);
        // определяем, какие столбцы из курсора будут выводиться в ListView
        String[] headers1 = new String[]{DatabaseHelper.COLUMN_ID_DOCTOR_MAP, DatabaseHelper.COLUMN_DATE_MAP,
